...
class PointNetPlusPlus(nn.Module):
    def __init__(self, input_channels, output_channels):
        ...
        self.jacobikan1 = KAN(1024, 512, poly_degree)
        self.jacobikan2 = KAN(512, 256, poly_degree)
        self.jacobikan3 = KAN(256, output_channels, poly_degree)
    ...
    def forward(self, x):
        ...
        x = self.bn1(self.jacobikan1(x))
        x = self.drop1(x)
        x = self.bn2(self.jacobikan2(x))
        x = self.drop2(x)
        x = self.jacobikan3(x)
        return x
